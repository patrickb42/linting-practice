...
const badName=index=>{ 
   let type="number;"
    let a=0;let b=1
    let this_i$_theVariableThat_will_be_returned_butItWill_also_be_theThingToHoldThe_newValue_thatIsNextInTheCycle_=1
    ...
    for( let i=1;i<index;i++ ){
      ...
      console.log('line 12 ' + this_i$_theVariableThat_will_be_returned_butItWill_also_be_theThingToHoldThe_newValue_thatIsNextInTheCycle_) 
    }
